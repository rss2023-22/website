...
# calculate loss for everything
loss1 = 0.0
for dist in test1:
    loss1 += abs(dist-0.5)
loss1 /= len(test1)
print('Loss Test 1 = '+str(loss1))

loss2 = 0.0
for dist in test2:
    loss2 += abs(dist-0.5)
loss2 /= len(test2)
print('Loss Test 2 = '+str(loss2))

loss3 = 0.0
for dist in test3:
    loss3 += abs(dist-0.5)
loss3 /= len(test3)
print('Loss Test 3 = '+str(loss3))

loss4 = 0.0
for dist in test4:
    loss4 += abs(dist-0.5)
loss4 /= len(test4)
print('Loss Test 4 = '+str(loss4))

loss5 = 0.0
for dist in test5:
    loss5 += abs(dist-0.5)
loss5 /= len(test5)
print('Loss Test 5 = '+str(loss5))

# compute scores
score1 = 1/(1+(1*loss1)**2)
print('score1='+str(score1))
score2 = 1/(1+(1*loss2)**2)
print('score2='+str(score2))
score3 = 1/(1+(1*loss3)**2)
print('score3='+str(score3))
score4 = 1/(1+(1*loss4)**2)
print('score4='+str(score4))
score5 = 1/(1+(1*loss5)**2)
